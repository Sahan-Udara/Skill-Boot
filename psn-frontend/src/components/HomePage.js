    ...
    <Container fluid>
      <Row className={styles.container}>
        <Col className={`${styles.colContainerLeft} ${styles.leftBackground}`}>
          ...
          {/* <Row>
              <h3 className="my-3">
                <BsFillBookFill /> Discover what the world is learning right now
              </h3>
            </Row> */}
            {/* <Row>
              <h3 className="my-3">
        ...
        <Col className={styles.colContainerRight}>
          <div className={styles.colWithButtons}>
            ...
            <Row>
              <h1 className="text-success mb-3">SKILLBOOT</h1>
            </Row>
            <br />
            <Row>
              <h3 className="text-success mb-3">Join SkillBoot Network Today</h3>
            </Row>{" "}
            <br />
            <Row>
